  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
		...
		<form action="eliminarUsuarioPost">
						  <div class="eliminar-form">
		    <label for="nombre">Ingrese id del usuario a eliminar</label>
		    <input type="text" class="form-control" id="nombre" name="userid">
